...
barrier法と内点法の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-inequality-constraints-kkt, prep-exponents-logarithms

---

## 直感

barrier法、内点法を、小さな例から一般式へ広げる。
...
[演習](/exercises/opt-barrier-interior-point)
