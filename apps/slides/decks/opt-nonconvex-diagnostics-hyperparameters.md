...
非凸最適化の診断とhyperparameterの定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-adaptive-optimizers, num-verification-benchmarking-reproducibility

---

## 直感

非凸最適化の診断、hyperparameterを、小さな例から一般式へ広げる。

---

## 記号と定義

非凸最適化の診断、hyperparameter
