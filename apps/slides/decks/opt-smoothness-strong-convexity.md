...
滑らかさと強凸性の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-convex-sets-functions, calc-hessian-second-order

---

## 直感

滑らかさ、強凸性を、小さな例から一般式へ広げる。
...
滑らかさと強凸性は、後続の数値計算・データ解析・機械学習で前提となる。
...
[演習](/exercises/opt-smoothness-strong-convexity)
