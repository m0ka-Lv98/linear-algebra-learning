...
滑らかさと強凸性で、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- 滑らかさと強凸性の定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** opt-convex-sets-functions, calc-hessian-second-order

---

## 図解

<img src="./assets/course-06/opt-smoothness-strong-convexity.png" style="max-height: 330px; display:block; margin:0 auto;" />
