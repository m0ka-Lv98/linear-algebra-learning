...
「直交基底と正規直交基底」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 直交基底、正規直交基底の定義と成立条件を説明できる
- 直交基底と正規直交基底を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

直交基底と正規直交基底を、数式、shape、幾何、アルゴリズム、数値上の注意から理解する。スカラーは小文字、ベクトルは太字小文字、行列は太字大文字で表す。
...
1. 直交基底、正規直交基底の定義と成立条件を説明できる
2. 直交基底と正規直交基底を小規模に計算・実装し検算できる
