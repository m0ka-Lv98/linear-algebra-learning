...
OLSとdesign matrixの定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
la-least-squares-geometry, stat-linear-regression-probabilistic-model

---

## 直感

OLS、design、matrixを、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-ols-design-matrices)
