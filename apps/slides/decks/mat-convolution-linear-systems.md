...
畳み込みと線形時不変系の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
mat-fourier-bases-dft, la-matrices-data-linear-maps

---

## 直感

畳み込み、線形時不変系を、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-convolution-linear-systems)
