...
「包含排除原理と二重数え上げ」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 包含排除原理、二重数え上げの定義と成立条件を説明できる
- 包含排除原理と二重数え上げを小規模に計算・実装し検算できる
...
1. 包含排除原理、二重数え上げの定義と成立条件を説明できる
2. 包含排除原理と二重数え上げを小規模に計算・実装し検算できる
