...
包含排除原理と二重数え上げを定義し、証明・アルゴリズム・計算量へ接続する。
...
2集合・3集合の包含排除、重複補正、全射、二重数え上げ、組合せ恒等式、degree sumを例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

2集合・3集合の包含排除、重複補正、全射、二重数え上げ、組合せ恒等式、degree sum
...
[演習](/exercises/dm-inclusion-exclusion-double-counting)
