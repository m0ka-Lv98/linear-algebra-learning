...
random projectionとJohnson–Lindenstraussの定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
num-randomized-numerical-linear-algebra, prob-laws-large-numbers-central-limit-theorem

---

## 直感

random、projection、Johnson–Lindenstraussを、小さな例から一般式へ広げる。
