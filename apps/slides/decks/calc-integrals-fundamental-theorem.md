...
「積分と微積分学の基本定理」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 積分、微積分学の基本定理の定義と成立条件を説明できる
- 積分と微積分学の基本定理を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

符号付き面積、分割、Riemann和、定積分、不定積分、原始関数、積分の線形性を扱う。$F'=f$、$\int a^b$ $f=F(b)-F(a)$、$d/dx\int a^x$ $f(t)dt=f(x)$を説明する。 数式の仮定と結論、ベクトル・行列の次元、Python/NumPyでの数値確認を区別して説明する。
...
1. 積分、微積分学の基本定理の定義と成立条件を説明できる
2. 積分と微積分学の基本定理を小規模に計算・実装し検算できる
