...
SVM・margin・kernelの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
opt-inequality-constraints-kkt, la-inner-products-norms-angles

---

## 直感

SVM、margin、kernelを、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-svm-margin-kernels)
