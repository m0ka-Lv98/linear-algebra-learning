...
「ベクトルと線形結合」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- ベクトル、線形結合の定義と成立条件を説明できる
- ベクトルと線形結合を小規模に計算・実装し検算できる
...
1. ベクトル、線形結合の定義と成立条件を説明できる
2. ベクトルと線形結合を小規模に計算・実装し検算できる
...
[教科書](../../textbook/la-vectors-linear-combinations)
