...
multi-agent systemの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-agents-planning-memory, dm-graphs-representations-degrees

---

## 直感

multi-agent、systemを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-multi-agent-systems)
