...
「同時分布・周辺分布・条件付き分布」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 同時分布、周辺分布、条件付き分布の定義と成立条件を説明できる
- 同時分布・周辺分布・条件付き分布を小規模に計算・実装し検算できる
...
1. 同時分布、周辺分布、条件付き分布の定義と成立条件を説明できる
2. 同時分布・周辺分布・条件付き分布を小規模に計算・実装し検算できる
