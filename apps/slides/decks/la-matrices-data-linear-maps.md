...
「行列をデータと線形写像として見る」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 行列をデータ、線形写像、して見るの定義と成立条件を説明できる
- 行列をデータと線形写像として見るを小規模に計算・実装し検算できる
...
1. 行列をデータ、線形写像、して見るの定義と成立条件を説明できる
2. 行列をデータと線形写像として見るを小規模に計算・実装し検算できる
