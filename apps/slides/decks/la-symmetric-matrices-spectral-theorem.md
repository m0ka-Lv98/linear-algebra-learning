...
「対称行列とスペクトル定理」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 対称行列、スペクトル定理の定義と成立条件を説明できる
- 対称行列とスペクトル定理を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

対称行列とスペクトル定理を、数式、shape、幾何、アルゴリズム、数値上の注意から理解する。スカラーは小文字、ベクトルは太字小文字、行列は太字大文字で表す。
...
1. 対称行列、スペクトル定理の定義と成立条件を説明できる
2. 対称行列とスペクトル定理を小規模に計算・実装し検算できる
