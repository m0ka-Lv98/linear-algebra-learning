...
「微分と変化率」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 微分、変化率の定義と成立条件を説明できる
- 微分と変化率を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

平均変化率から瞬間変化率、接線、導関数へ進む。差分商、微分可能なら連続、連続でも微分不可能な例、forward differenceとcentral differenceの予告を扱う。$f(x)=x^2$を定義から微分して2xを得る。 数式の仮定と結論、ベクトル・行列の次元、Python/NumPyでの数値確認を区別して説明する。

---

## 中心となる式・記号

- $f(x)=x^2$を定義から微分して2xを得る
...
1. 微分、変化率の定義と成立条件を説明できる
2. 微分と変化率を小規模に計算・実装し検算できる
