...
正準相関分析の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
prob-covariance-correlation, la-singular-value-decomposition

---

## 直感

正準相関分析を、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-cca-multiview)
