...
推定量・バイアス・分散・MSEを定義し、観測データと機械学習へ接続する。
...
母数、推定量、推定値、バイアス、不偏性、分散、MSE、bias–variance decompositionを表、曲線、または分布の形として観察する。

---

## 記号と定義

母数、推定量、推定値、バイアス、不偏性、分散、MSE、bias–variance decomposition
