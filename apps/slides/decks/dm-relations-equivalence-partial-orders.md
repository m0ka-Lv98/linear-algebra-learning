...
関係・同値関係・半順序を定義し、証明・アルゴリズム・計算量へ接続する。
...
二項関係、反射性、対称性、反対称性、推移性、同値関係、同値類、分割、半順序、全順序を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

二項関係、反射性、対称性、反対称性、推移性、同値関係、同値類、分割、半順序、全順序
...
[演習](/exercises/dm-relations-equivalence-partial-orders)
