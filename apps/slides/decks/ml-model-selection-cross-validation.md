...
model selectionとcross-validationの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
ml-bias-variance-regularization, prob-laws-large-numbers-central-limit-theorem

---

## 直感

model、selection、cross-validationを、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-model-selection-cross-validation)
