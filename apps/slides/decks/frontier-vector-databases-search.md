...
vector searchとindexで、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- vector searchとindexの定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** la-inner-products-norms-angles, ml-knn-distance-methods

---

## 図解

<img src="./assets/course-10/frontier-vector-databases-search.png" style="max-height: 330px; display:block; margin:0 auto;" />
...
query点とvector database点群、top-k近傍を描く。
...
vector searchとindexは、後続の数値計算・データ解析・機械学習で前提となる。
...
- vector searchとindexを図→式→小例の順で説明できるか
- 条件を1つ外した反例を作れるか
