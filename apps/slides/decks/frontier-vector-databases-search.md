...
vector searchとindexの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
la-inner-products-norms-angles, ml-knn-distance-methods

---

## 直感

vector、search、indexを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-vector-databases-search)
