...
評価指標・calibration・class imbalanceの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
stat-hypothesis-testing, ml-softmax-multiclass

---

## 直感

評価指標、calibration、class、imbalanceを、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-metrics-calibration-imbalance)
