...
GLSと相関誤差の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
mat-wls-inverse-variance, prob-multivariate-normal-distribution

---

## 直感

GLS、相関誤差を、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-gls-correlated-errors)
