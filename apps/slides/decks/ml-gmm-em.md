...
Gaussian mixtureとEMの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
prob-multivariate-normal-distribution, stat-likelihood-maximum-likelihood

---

## 直感

Gaussian、mixture、EMを、小さな例から一般式へ広げる。
