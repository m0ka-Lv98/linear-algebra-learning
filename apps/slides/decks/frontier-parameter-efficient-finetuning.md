...
parameter-efficient fine-tuningの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
dl-efficient-training-inference, opt-proximal-gradient

---

## 直感

parameter-efficient、fine-tuningを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-parameter-efficient-finetuning)
