...
synthetic dataとdata curationの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
ml-problem-formulation-data-splits, frontier-foundation-model-evaluation

---

## 直感

synthetic、data、curationを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-synthetic-data-data-curation)
