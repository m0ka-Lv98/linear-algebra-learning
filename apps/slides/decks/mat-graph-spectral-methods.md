...
グラフspectral methodの定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
dm-graphs-representations-degrees, la-symmetric-matrices-spectral-theorem

---

## 直感

グラフspectral、methodを、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-graph-spectral-methods)
