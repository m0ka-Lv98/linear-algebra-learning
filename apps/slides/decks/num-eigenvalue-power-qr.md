...
固有値計算・べき乗法・QR法の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
la-eigenvalues-eigenvectors, la-gram-schmidt-qr, num-convergence-orders-stopping

---

## 直感

固有値計算、べき乗法、QR法を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-eigenvalue-power-qr)
