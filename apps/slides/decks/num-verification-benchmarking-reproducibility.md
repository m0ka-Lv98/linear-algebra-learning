...
数値計算の検証・benchmark・再現性の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
num-convergence-orders-stopping, num-floating-point-rounding, prep-numerical-checks-reproducibility

---

## 直感

数値計算の検証、benchmark、再現性を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-verification-benchmarking-reproducibility)
