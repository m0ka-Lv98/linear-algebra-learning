...
「数え上げ・標本空間・事象」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 数え上げ、標本空間、事象の定義と成立条件を説明できる
- 数え上げ・標本空間・事象を小規模に計算・実装し検算できる
...
1. 数え上げ、標本空間、事象の定義と成立条件を説明できる
2. 数え上げ・標本空間・事象を小規模に計算・実装し検算できる
