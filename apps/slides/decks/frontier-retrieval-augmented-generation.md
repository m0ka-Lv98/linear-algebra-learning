...
Retrieval-Augmented Generationの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-foundation-model-paradigm, ml-knn-distance-methods

---

## 直感

Retrieval-Augmented、Generationを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-retrieval-augmented-generation)
