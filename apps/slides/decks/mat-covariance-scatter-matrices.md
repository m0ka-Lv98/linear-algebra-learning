...
共分散行列とscatter matrixの定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
prob-covariance-correlation, la-symmetric-matrices-spectral-theorem

---

## 直感

共分散行列、scatter、matrixを、小さな例から一般式へ広げる。

---

## 記号と定義

共分散行列、scatter、matrix
...
[演習](/exercises/mat-covariance-scatter-matrices)
