...
深層modelの評価・robustness・安全性の定義、計算手順、成立条件を整理し、深層学習の後続Topicへ接続する。
...
ml-uncertainty-interpretability-monitoring, stat-hypothesis-testing

---

## 直感

深層modelの評価、robustness、安全性を、小さな例から一般式へ広げる。
...
[演習](/exercises/dl-evaluation-robustness-safety)
