...
「期待値・分散・モーメント」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 期待値、分散、モーメントの定義と成立条件を説明できる
- 期待値・分散・モーメントを小規模に計算・実装し検算できる
...
1. 期待値、分散、モーメントの定義と成立条件を説明できる
2. 期待値・分散・モーメントを小規模に計算・実装し検算できる
