...
特徴量設計と特徴選択の定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
mat-data-matrices-centering-scaling, mat-ridge-lasso-elastic-net

---

## 直感

特徴量設計、特徴選択を、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-feature-engineering-selection)
