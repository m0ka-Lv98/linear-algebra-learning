...
「漸近記法と増加率」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 漸近記法、増加率の定義と成立条件を説明できる
- 漸近記法と増加率を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

この章では漸近記法と増加率を、定義、証明、反例、アルゴリズムの仕様という順で学ぶ。input size、worst case、average case、Big O、Big Omega、Big Theta、上界、下界、対数、指数を、数学的な主張から計算機科学の設計へ接続する。

---

## 記号と定義

input size、worst case、average case、Big O、Big Omega、Big Theta、上界、下界、対数、指数を定義し、次の式を読み解く。
...
漸近記法と増加率は、定義・仮定・証明・停止性・計算量・反例を順に確認すると安全に扱える。
...
1. 漸近記法、増加率の定義と成立条件を説明できる
2. 漸近記法と増加率を小規模に計算・実装し検算できる
