...
long contextとmemoryの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-agents-planning-memory, dl-attention-mechanism

---

## 直感

long、context、memoryを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-long-context-memory)
