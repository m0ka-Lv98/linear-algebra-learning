...
tool useとfunction callingの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
dm-algorithm-specifications-correctness, frontier-in-context-learning-prompting

---

## 直感

tool、use、function、callingを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-tool-use-function-calling)
