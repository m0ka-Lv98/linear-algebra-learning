...
ODEの安定性・硬さ・陰解法の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
num-ode-euler-runge-kutta, num-errors-conditioning-stability

---

## 直感

ODEの安定性、硬さ、陰解法を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-ode-stability-stiffness)
