...
「直接証明・対偶・背理法・場合分け」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 直接証明、対偶、背理法、場合分けの定義と成立条件を説明できる
- 直接証明・対偶・背理法・場合分けを小規模に計算・実装し検算できる
...
1. 直接証明、対偶、背理法、場合分けの定義と成立条件を説明できる
2. 直接証明・対偶・背理法・場合分けを小規模に計算・実装し検算できる
