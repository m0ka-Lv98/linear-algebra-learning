...
「含意・同値・必要十分条件」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 含意、同値、必要十分条件の定義と成立条件を説明できる
- 含意・同値・必要十分条件を小規模に計算・実装し検算できる
...
1. 含意、同値、必要十分条件の定義と成立条件を説明できる
2. 含意・同値・必要十分条件を小規模に計算・実装し検算できる
