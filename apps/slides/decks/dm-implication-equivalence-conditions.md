...
含意・同値・必要十分条件を定義し、証明・アルゴリズム・計算量へ接続する。
...
仮定、結論、必要条件、十分条件、必要十分条件、逆、裏、対偶、同値、含意の連鎖を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

仮定、結論、必要条件、十分条件、必要十分条件、逆、裏、対偶、同値、含意の連鎖
...
[演習](/exercises/dm-implication-equivalence-conditions)
