...
連立方程式の直接法とpivotingの定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
la-lu-factorization, num-errors-conditioning-stability

---

## 直感

連立方程式の直接法、pivotingを、小さな例から一般式へ広げる。
...
[演習](/exercises/num-direct-solvers-pivoting)
