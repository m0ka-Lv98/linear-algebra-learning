...
「行列式・体積・可逆性」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 行列式、体積、可逆性の定義と成立条件を説明できる
- 行列式・体積・可逆性を小規模に計算・実装し検算できる
...
1. 行列式、体積、可逆性の定義と成立条件を説明できる
2. 行列式・体積・可逆性を小規模に計算・実装し検算できる
