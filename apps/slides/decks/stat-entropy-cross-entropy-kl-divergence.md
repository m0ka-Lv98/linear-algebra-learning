...
エントロピー・交差エントロピー・KLダイバージェンスを定義し、観測データと機械学習へ接続する。
...
self-information、entropy、cross entropy、KLダイバージェンス、非対称性、coding、classification lossを表、曲線、または分布の形として観察する。

---

## 記号と定義

self-information、entropy、cross entropy、KLダイバージェンス、非対称性、coding、classification loss
