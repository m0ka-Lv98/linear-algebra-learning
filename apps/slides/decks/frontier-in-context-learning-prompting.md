...
in-context learningとprompt設計の定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-tokenization-embeddings-context, ml-problem-formulation-data-splits

---

## 直感

in-context、learning、prompt設計を、小さな例から一般式へ広げる。

---

## 記号と定義

in-context、learning、prompt設計
...
[演習](/exercises/frontier-in-context-learning-prompting)
