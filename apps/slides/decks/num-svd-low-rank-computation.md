...
SVDと低ランク計算の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
la-singular-value-decomposition, la-low-rank-approximation, num-eigenvalue-power-qr

---

## 直感

SVD、低ランク計算を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-svd-low-rank-computation)
