...
確率変数・CDF・PMF・PDFを定義し、観測データと機械学習へ接続する。
...
確率変数、離散型・連続型、PMF、PDF、CDF、support、正規化を表、曲線、または分布の形として観察する。

---

## 記号と定義

確率変数、離散型・連続型、PMF、PDF、CDF、support、正規化
...
[演習](/exercises/prob-random-variables-cdf-pmf-pdf)
