...
point estimate、interval estimate、confidence level、standard error、95%信頼区間、repeated samplingを表、曲線、または分布の形として観察する。

---

## 記号と定義

point estimate、interval estimate、confidence level、standard error、95%信頼区間、repeated sampling
...
[演習](/exercises/stat-confidence-intervals)
