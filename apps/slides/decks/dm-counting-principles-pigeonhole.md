...
加法原理・乗法原理・鳩の巣原理を定義し、証明・アルゴリズム・計算量へ接続する。
...
加法原理、乗法原理、decision tree、鳩の巣原理、一般化、上限・下限、数え漏れ、二重計数を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

加法原理、乗法原理、decision tree、鳩の巣原理、一般化、上限・下限、数え漏れ、二重計数
...
[演習](/exercises/dm-counting-principles-pigeonhole)
