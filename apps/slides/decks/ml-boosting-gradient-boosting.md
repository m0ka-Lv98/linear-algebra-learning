...
boostingとgradient boostingの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
ml-decision-trees, opt-gradient-descent-convergence

---

## 直感

boosting、gradientを、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-boosting-gradient-boosting)
