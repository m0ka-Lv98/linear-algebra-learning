...
接線・線形近似、展開点a、次数r、剰余、近似範囲を扱う。$f(x)\approx f(a)+f'(a)(x-a)$、Σ $f^(k)(a)/k$!($x-a)^k$、$e^x\approx 1+x+x^2/2$を例にする。 数式の仮定と結論、ベクトル・行列の次元、Python/NumPyでの数値確認を区別して説明する。
