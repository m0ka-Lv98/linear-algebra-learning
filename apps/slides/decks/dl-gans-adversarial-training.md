...
GANとadversarial trainingの定義、計算手順、成立条件を整理し、深層学習の後続Topicへ接続する。
...
stat-likelihood-maximum-likelihood, opt-nonconvex-diagnostics-hyperparameters

---

## 直感

GAN、adversarial、trainingを、小さな例から一般式へ広げる。
