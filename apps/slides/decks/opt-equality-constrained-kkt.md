...
等式制約とKKT条件の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
calc-lagrange-multipliers, opt-optimality-conditions

---

## 直感

等式制約、KKT条件を、小さな例から一般式へ広げる。
...
[演習](/exercises/opt-equality-constrained-kkt)
