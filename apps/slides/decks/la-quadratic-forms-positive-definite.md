...
「二次形式と正定値行列」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 二次形式、正定値行列の定義と成立条件を説明できる
- 二次形式と正定値行列を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

二次形式と正定値行列を、数式、shape、幾何、アルゴリズム、数値上の注意から理解する。スカラーは小文字、ベクトルは太字小文字、行列は太字大文字で表す。
...
1. 二次形式、正定値行列の定義と成立条件を説明できる
2. 二次形式と正定値行列を小規模に計算・実装し検算できる
...
[教科書](../../textbook/la-quadratic-forms-positive-definite)
