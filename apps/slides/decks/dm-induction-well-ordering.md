...
「数学的帰納法・強い帰納法・整列原理」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 数学的帰納法、強い帰納法、整列原理の定義と成立条件を説明できる
- 数学的帰納法・強い帰納法・整列原理を小規模に計算・実装し検算できる
...
1. 数学的帰納法、強い帰納法、整列原理の定義と成立条件を説明できる
2. 数学的帰納法・強い帰納法・整列原理を小規模に計算・実装し検算できる
