...
数学的帰納法・強い帰納法・整列原理を定義し、証明・アルゴリズム・計算量へ接続する。
...
帰納法の基底、帰納法の仮定、帰納段階、強い帰納法、整列原理、再帰構造、漸化式を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

帰納法の基底、帰納法の仮定、帰納段階、強い帰納法、整列原理、再帰構造、漸化式
...
[演習](/exercises/dm-induction-well-ordering)
