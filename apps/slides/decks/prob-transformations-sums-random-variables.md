...
線形変換、和の期待値、独立な和の分散、CDF法、Jacobian、convolutionを表、曲線、または分布の形として観察する。

---

## 記号と定義

線形変換、和の期待値、独立な和の分散、CDF法、Jacobian、convolution
...
[演習](/exercises/prob-transformations-sums-random-variables)
