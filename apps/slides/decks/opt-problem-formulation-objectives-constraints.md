...
最適化問題の定式化の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
calc-unconstrained-optimization, calc-lagrange-multipliers

---

## 直感

最適化問題の定式化を、小さな例から一般式へ広げる。
...
最適化問題の定式化は、後続の数値計算・データ解析・機械学習で前提となる。
