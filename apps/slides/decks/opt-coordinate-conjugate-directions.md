...
座標降下法と共役方向の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-gradient-descent-convergence, num-iterative-linear-solvers

---

## 直感

座標降下法、共役方向を、小さな例から一般式へ広げる。
...
[演習](/exercises/opt-coordinate-conjugate-directions)
