...
Lagrange双対とdual gradientの定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
Lagrange双対、dual、gradientを、小さな例から一般式へ広げる。

---

## 記号と定義

Lagrange双対、dual、gradient
...
[演習](/exercises/opt-duality-dual-gradient)
