...
不確実性・解釈・監視で、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- 不確実性・解釈・監視の定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** stat-bayesian-inference-map, ml-model-selection-cross-validation

---

## 図解

<img src="./assets/course-08/ml-uncertainty-interpretability-monitoring.png" style="max-height: 330px; display:block; margin:0 auto;" />
...
時間に沿うfeature driftとerror rateを並べる。
