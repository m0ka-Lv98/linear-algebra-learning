...
「有向グラフ・DAG・トポロジカル順序」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 有向グラフ、DAG、トポロジカル順序の定義と成立条件を説明できる
- 有向グラフ・DAG・トポロジカル順序を小規模に計算・実装し検算できる
...
1. 有向グラフ、DAG、トポロジカル順序の定義と成立条件を説明できる
2. 有向グラフ・DAG・トポロジカル順序を小規模に計算・実装し検算できる
