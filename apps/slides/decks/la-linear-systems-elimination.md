...
「連立一次方程式とガウス消去法」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 連立一次方程式、ガウス消去法の定義と成立条件を説明できる
- 連立一次方程式とガウス消去法を小規模に計算・実装し検算できる
...
1. 連立一次方程式、ガウス消去法の定義と成立条件を説明できる
2. 連立一次方程式とガウス消去法を小規模に計算・実装し検算できる
