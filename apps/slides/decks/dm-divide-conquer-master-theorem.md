...
「分割統治法とMaster theorem」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 分割統治法、Master、theoremの定義と成立条件を説明できる
- 分割統治法とMaster theoremを小規模に計算・実装し検算できる

---

## まず全体像をつかむ

この章では分割統治法とMaster theoremを、定義、証明、反例、アルゴリズムの仕様という順で学ぶ。divide、conquer、combine、recursion tree、merge sort、binary search、Master theorem、適用条件を、数学的な主張から計算機科学の設計へ接続する。

---

## 記号と定義

divide、conquer、combine、recursion tree、merge sort、binary search、Master theorem、適用条件を定義し、次の式を読み解く。
...
分割統治法とMaster theoremは、定義・仮定・証明・停止性・計算量・反例を順に確認すると安全に扱える。
...
1. 分割統治法、Master、theoremの定義と成立条件を説明できる
2. 分割統治法とMaster theoremを小規模に計算・実装し検算できる
