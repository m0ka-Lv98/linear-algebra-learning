...
分割統治法とMaster theoremを定義し、証明・アルゴリズム・計算量へ接続する。
...
divide、conquer、combine、recursion tree、merge sort、binary search、Master theorem、適用条件を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

divide、conquer、combine、recursion tree、merge sort、binary search、Master theorem、適用条件
