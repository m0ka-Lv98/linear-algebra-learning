...
agent・planning・memoryの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-tool-use-function-calling, dm-directed-graphs-dags-topological-order

---

## 直感

agent、planning、memoryを、小さな例から一般式へ広げる。
