...
「行列ノルムと条件数」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 行列ノルム、条件数の定義と成立条件を説明できる
- 行列ノルムと条件数を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

行列ノルムと条件数を、数式、shape、幾何、アルゴリズム、数値上の注意から理解する。スカラーは小文字、ベクトルは太字小文字、行列は太字大文字で表す。
...
1. 行列ノルム、条件数の定義と成立条件を説明できる
2. 行列ノルムと条件数を小規模に計算・実装し検算できる
...
[教科書](../../textbook/la-matrix-norms-condition-number)
