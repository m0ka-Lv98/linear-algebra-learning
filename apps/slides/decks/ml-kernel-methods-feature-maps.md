...
kernel methodと特徴写像で、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- kernel methodと特徴写像の定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** ml-svm-margin-kernels, la-quadratic-forms-positive-definite

---

## 図解

<img src="./assets/course-08/ml-kernel-methods-feature-maps.png" style="max-height: 330px; display:block; margin:0 auto;" />
...
kernel methodと特徴写像は、後続の数値計算・データ解析・機械学習で前提となる。
...
- kernel methodと特徴写像を図→式→小例の順で説明できるか
- 条件を1つ外した反例を作れるか
