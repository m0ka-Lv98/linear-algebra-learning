...
kernel methodと特徴写像の定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
ml-svm-margin-kernels, la-quadratic-forms-positive-definite

---

## 直感

kernel、method、特徴写像を、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-kernel-methods-feature-maps)
