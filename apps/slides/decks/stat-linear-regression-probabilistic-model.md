...
線形回帰の確率モデルを定義し、観測データと機械学習へ接続する。
...
design matrix、response、parameter、Gaussian noise、homoscedasticity、residual、MLE、WLSへの接続を表、曲線、または分布の形として観察する。

---

## 記号と定義

design matrix、response、parameter、Gaussian noise、homoscedasticity、residual、MLE、WLSへの接続
...
[演習](/exercises/stat-linear-regression-probabilistic-model)
