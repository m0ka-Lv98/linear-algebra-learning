...
WLSと逆分散重みの定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
la-weighted-least-squares-introduction, stat-linear-regression-probabilistic-model

---

## 直感

WLS、逆分散重みを、小さな例から一般式へ広げる。
