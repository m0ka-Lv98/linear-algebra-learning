...
「Bayesian推論とMAP推定」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- Bayesian推論、MAP推定の定義と成立条件を説明できる
- Bayesian推論とMAP推定を小規模に計算・実装し検算できる
...
1. Bayesian推論、MAP推定の定義と成立条件を説明できる
2. Bayesian推論とMAP推定を小規模に計算・実装し検算できる
