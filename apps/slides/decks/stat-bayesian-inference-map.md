...
Bayesian推論とMAP推定を定義し、観測データと機械学習へ接続する。
...
prior、likelihood、posterior、evidence、conjugate prior、posterior mean、MAP、MLEとの違いを表、曲線、または分布の形として観察する。

---

## 記号と定義

prior、likelihood、posterior、evidence、conjugate prior、posterior mean、MAP、MLEとの違い
