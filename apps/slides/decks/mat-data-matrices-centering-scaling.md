...
データ行列・中心化・標準化の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
prep-numpy-arrays-shapes, stat-linear-regression-probabilistic-model

---

## 直感

データ行列、中心化、標準化を、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-data-matrices-centering-scaling)
