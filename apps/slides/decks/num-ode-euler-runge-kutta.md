...
常微分方程式・Euler法・Runge–Kutta法の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
calc-derivatives-rates, calc-integrals-fundamental-theorem, num-convergence-orders-stopping

---

## 直感

常微分方程式、Euler法、Runge–Kutta法を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-ode-euler-runge-kutta)
