...
不確実性・calibration・abstentionの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
ml-uncertainty-interpretability-monitoring, stat-confidence-intervals

---

## 直感

不確実性、calibration、abstentionを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-uncertainty-calibration-abstention)
