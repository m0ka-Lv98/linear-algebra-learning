...
tokenization・embedding・contextの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
dl-embeddings-representation-learning, dl-transformers

---

## 直感

tokenization、embedding、contextを、小さな例から一般式へ広げる。
