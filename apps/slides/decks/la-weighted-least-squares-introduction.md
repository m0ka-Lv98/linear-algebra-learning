...
「重み付き最小二乗法の導入」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 重み付き最小二乗法の導入の定義と成立条件を説明できる
- 重み付き最小二乗法の導入を小規模に計算・実装し検算できる
...
1. 重み付き最小二乗法の導入の定義と成立条件を説明できる
2. 重み付き最小二乗法の導入を小規模に計算・実装し検算できる
