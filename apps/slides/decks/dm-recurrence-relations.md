...
この章では漸化式を、定義、証明、反例、アルゴリズムの仕様という順で学ぶ。sequence、recurrence relation、initial condition、線形漸化式、反復、代入、特性方程式、Fibonacci、runtime recurrenceを、数学的な主張から計算機科学の設計へ接続する。

---

## 記号と定義

sequence、recurrence relation、initial condition、線形漸化式、反復、代入、特性方程式、Fibonacci、runtime recurrenceを定義し、次の式を読み解く。
...
漸化式は、定義・仮定・証明・停止性・計算量・反例を順に確認すると安全に扱える。
