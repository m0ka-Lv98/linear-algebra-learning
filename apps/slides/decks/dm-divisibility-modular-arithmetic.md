...
整除性と合同算術を定義し、証明・アルゴリズム・計算量へ接続する。
...
整除、約数、倍数、最大公約数、Euclidean algorithm、合同、剰余類、modular arithmetic、hash、暗号を例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

整除、約数、倍数、最大公約数、Euclidean algorithm、合同、剰余類、modular arithmetic、hash、暗号
...
[演習](/exercises/dm-divisibility-modular-arithmetic)
