...
確率的勾配法の定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-gradient-descent-convergence, prob-expectation-variance-moments

---

## 直感

確率的勾配法を、小さな例から一般式へ広げる。
...
[演習](/exercises/opt-stochastic-gradient)
