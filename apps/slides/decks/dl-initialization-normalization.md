...
初期化とnormalizationの定義、計算手順、成立条件を整理し、深層学習の後続Topicへ接続する。
...
prob-expectation-variance-moments, dl-backprop-computation-graphs

---

## 直感

初期化、normalizationを、小さな例から一般式へ広げる。
...
[演習](/exercises/dl-initialization-normalization)
