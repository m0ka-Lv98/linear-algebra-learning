...
初期化とnormalizationで、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- 初期化とnormalizationの定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** prob-expectation-variance-moments, dl-backprop-computation-graphs

---

## 図解

<img src="./assets/course-09/dl-initialization-normalization.png" style="max-height: 330px; display:block; margin:0 auto;" />
...
初期化とnormalizationは、後続の数値計算・データ解析・機械学習で前提となる。
...
- 初期化とnormalizationを図→式→小例の順で説明できるか
- 条件を1つ外した反例を作れるか
