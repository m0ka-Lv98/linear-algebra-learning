...
tensorと多重線形構造の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
prep-symbols-types-shapes, la-singular-value-decomposition

---

## 直感

tensor、多重線形構造を、小さな例から一般式へ広げる。
...
[演習](/exercises/mat-tensors-multilinear-overview)
