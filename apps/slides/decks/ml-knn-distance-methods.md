...
k近傍法と距離学習の定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
la-inner-products-norms-angles, ml-problem-formulation-data-splits

---

## 直感

k近傍法、距離学習を、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-knn-distance-methods)
