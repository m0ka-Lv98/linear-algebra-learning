...
- pretraining、scaling、lawの定義と成立条件を説明できる
- pretrainingとscaling lawを小規模に計算・実装し検算できる
...
1. pretraining、scaling、lawの定義と成立条件を説明できる
2. pretrainingとscaling lawを小規模に計算・実装し検算できる
