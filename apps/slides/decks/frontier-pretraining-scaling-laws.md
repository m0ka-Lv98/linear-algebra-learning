...
pretrainingとscaling lawの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
frontier-foundation-model-paradigm, dl-scaling-distributed-training

---

## 直感

pretraining、scaling、lawを、小さな例から一般式へ広げる。

---

## 記号と定義

pretraining、scaling、law
...
[演習](/exercises/frontier-pretraining-scaling-laws)
