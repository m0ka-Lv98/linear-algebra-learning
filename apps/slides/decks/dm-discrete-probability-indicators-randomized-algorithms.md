...
離散確率・指示変数・乱択アルゴリズムを定義し、証明・アルゴリズム・計算量へ接続する。
...
有限標本空間、indicator variable I_A、期待値の線形性、randomized algorithm、expected runtime、Monte Carlo、Las Vegas、hashingを例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

有限標本空間、indicator variable I_A、期待値の線形性、randomized algorithm、expected runtime、Monte Carlo、Las Vegas、hashing
...
[演習](/exercises/dm-discrete-probability-indicators-randomized-algorithms)
