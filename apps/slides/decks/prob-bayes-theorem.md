...
事前確率、尤度、周辺確率、事後確率、base-rate neglect、医療検査と分類を表、曲線、または分布の形として観察する。

---

## 記号と定義

事前確率、尤度、周辺確率、事後確率、base-rate neglect、医療検査と分類
...
[演習](/exercises/prob-bayes-theorem)
