...
mechanistic interpretabilityの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
dl-attention-mechanism, la-linear-maps-change-of-basis

---

## 直感

mechanistic、interpretabilityを、小さな例から一般式へ広げる。
