...
確率ベクトル、平均ベクトル、共分散行列、等密度面、marginal、conditional、whiteningを表、曲線、または分布の形として観察する。

---

## 記号と定義

確率ベクトル、平均ベクトル、共分散行列、等密度面、marginal、conditional、whitening
...
[演習](/exercises/prob-multivariate-normal-distribution)
