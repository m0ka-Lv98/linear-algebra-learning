...
機械学習問題の定式化とdata splitの定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
stat-estimators-bias-variance-mse, opt-problem-formulation-objectives-constraints

---

## 直感

機械学習問題の定式化、data、splitを、小さな例から一般式へ広げる。

---

## 記号と定義

機械学習問題の定式化、data、split
...
[演習](/exercises/ml-problem-formulation-data-splits)
