...
「大数の法則と中心極限定理」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 大数の法則、中心極限定理の定義と成立条件を説明できる
- 大数の法則と中心極限定理を小規模に計算・実装し検算できる
...
1. 大数の法則、中心極限定理の定義と成立条件を説明できる
2. 大数の法則と中心極限定理を小規模に計算・実装し検算できる
