...
「命題・論理演算・真理値表」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 命題、論理演算、真理値表の定義と成立条件を説明できる
- 命題・論理演算・真理値表を小規模に計算・実装し検算できる
...
1. 命題、論理演算、真理値表の定義と成立条件を説明できる
2. 命題・論理演算・真理値表を小規模に計算・実装し検算できる
