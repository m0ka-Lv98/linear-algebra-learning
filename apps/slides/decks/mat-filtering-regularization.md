...
filteringと正則化の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
mat-convolution-linear-systems, num-regularization-ill-posed-problems

---

## 直感

filtering、正則化を、小さな例から一般式へ広げる。
