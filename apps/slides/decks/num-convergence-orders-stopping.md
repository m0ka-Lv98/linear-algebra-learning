...
収束次数と停止条件の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
num-errors-conditioning-stability, calc-functions-limits-continuity

---

## 直感

収束次数、停止条件を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-convergence-orders-stopping)
