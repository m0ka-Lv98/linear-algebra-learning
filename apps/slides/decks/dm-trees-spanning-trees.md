...
「木と全域木」は何を表し、どの条件で使え、結果をどう検算するのか？
...
- 木、全域木の定義と成立条件を説明できる
- 木と全域木を小規模に計算・実装し検算できる

---

## まず全体像をつかむ

この章では木と全域木を、定義、証明、反例、アルゴリズムの仕様という順で学ぶ。tree、forest、root、parent、child、leaf、unique path、edge count、spanning tree、DFS、BFSを、数学的な主張から計算機科学の設計へ接続する。

---

## 記号と定義

tree、forest、root、parent、child、leaf、unique path、edge count、spanning tree、DFS、BFSを定義し、次の式を読み解く。
...
木と全域木は、定義・仮定・証明・停止性・計算量・反例を順に確認すると安全に扱える。
...
1. 木、全域木の定義と成立条件を説明できる
2. 木と全域木を小規模に計算・実装し検算できる
