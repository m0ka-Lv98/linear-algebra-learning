...
tree、forest、root、parent、child、leaf、unique path、edge count、spanning tree、DFS、BFSを例、反例、表、グラフ、擬似コードとして観察する。

---

## 記号と定義

tree、forest、root、parent、child、leaf、unique path、edge count、spanning tree、DFS、BFS
...
[演習](/exercises/dm-trees-spanning-trees)
