...
最小二乗法の数値解法の定義、計算手順、成立条件を整理し、数値計算の後続Topicへ接続する。
...
la-least-squares-computation-pseudoinverse, la-gram-schmidt-qr, num-errors-conditioning-stability

---

## 直感

最小二乗法の数値解法を、小さな例から一般式へ広げる。
...
[演習](/exercises/num-least-squares-qr-svd)
