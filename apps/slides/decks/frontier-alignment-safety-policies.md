...
alignment・安全policy・red teamingの定義、計算手順、成立条件を整理し、Frontierの後続Topicへ接続する。
...
dl-evaluation-robustness-safety, frontier-rlhf-preference-optimization

---

## 直感

alignment、安全policy、red、teamingを、小さな例から一般式へ広げる。
...
[演習](/exercises/frontier-alignment-safety-policies)
