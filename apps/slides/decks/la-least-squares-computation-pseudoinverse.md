...
「最小二乗法の計算と擬似逆行列」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 最小二乗法の計算、擬似逆行列の定義と成立条件を説明できる
- 最小二乗法の計算と擬似逆行列を小規模に計算・実装し検算できる
...
1. 最小二乗法の計算、擬似逆行列の定義と成立条件を説明できる
2. 最小二乗法の計算と擬似逆行列を小規模に計算・実装し検算できる
