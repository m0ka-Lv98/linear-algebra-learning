...
perceptronと多層networkの定義、計算手順、成立条件を整理し、深層学習の後続Topicへ接続する。
...
ml-logistic-regression, calc-multivariable-chain-rule

---

## 直感

perceptron、多層networkを、小さな例から一般式へ広げる。

---

## 記号と定義

perceptron、多層network
...
[演習](/exercises/dl-perceptron-mlp)
