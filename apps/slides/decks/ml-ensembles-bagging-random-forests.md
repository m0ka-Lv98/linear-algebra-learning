...
baggingとrandom forestで、何を入力し、代表式がどの量を出力し、どの成立条件を外すと結果が壊れるのか。

---

## 到達目標

- baggingとrandom forestの定義と代表式を言葉で説明できる
- 図と式の対応を説明できる
...
**前提:** ml-decision-trees, prob-expectation-variance-moments

---

## 図解

<img src="./assets/course-08/ml-ensembles-bagging-random-forests.png" style="max-height: 330px; display:block; margin:0 auto;" />
...
baggingとrandom forestは、後続の数値計算・データ解析・機械学習で前提となる。
...
- baggingとrandom forestを図→式→小例の順で説明できるか
- 条件を1つ外した反例を作れるか
