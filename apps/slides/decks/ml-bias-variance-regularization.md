...
bias–varianceと正則化の定義、計算手順、成立条件を整理し、機械学習の後続Topicへ接続する。
...
stat-estimators-bias-variance-mse, ml-problem-formulation-data-splits

---

## 直感

bias–variance、正則化を、小さな例から一般式へ広げる。
...
[演習](/exercises/ml-bias-variance-regularization)
