...
autoencoderとVAEの定義、計算手順、成立条件を整理し、深層学習の後続Topicへ接続する。
...
ml-dimensionality-reduction-pca-manifold, stat-bayesian-inference-map

---

## 直感

autoencoder、VAEを、小さな例から一般式へ広げる。
...
[演習](/exercises/dl-autoencoders-vae)
