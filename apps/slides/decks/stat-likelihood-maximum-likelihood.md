...
statistical model、parameter、likelihood、log-likelihood、独立標本、MLE、数値最適化を表、曲線、または分布の形として観察する。

---

## 記号と定義

statistical model、parameter、likelihood、log-likelihood、独立標本、MLE、数値最適化
