...
line searchとstep sizeの定義、計算手順、成立条件を整理し、最適化の後続Topicへ接続する。
...
opt-optimality-conditions, num-convergence-orders-stopping

---

## 直感

line、search、step、sizeを、小さな例から一般式へ広げる。
...
[演習](/exercises/opt-line-search-step-size)
