...
「線形写像と基底変換」は何を表し、どの条件で使え、結果をどう検算するのか？

---

## 到達目標

- 線形写像、基底変換の定義と成立条件を説明できる
- 線形写像と基底変換を小規模に計算・実装し検算できる
...
1. 線形写像、基底変換の定義と成立条件を説明できる
2. 線形写像と基底変換を小規模に計算・実装し検算できる
...
[教科書](../../textbook/la-linear-maps-change-of-basis)
