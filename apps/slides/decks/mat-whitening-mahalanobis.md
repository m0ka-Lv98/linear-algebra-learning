...
whiteningとMahalanobis距離の定義、計算手順、成立条件を整理し、データ解析の行列手法の後続Topicへ接続する。
...
prob-multivariate-normal-distribution, la-quadratic-forms-positive-definite

---

## 直感

whitening、Mahalanobis距離を、小さな例から一般式へ広げる。

---

## 記号と定義

whitening、Mahalanobis距離
