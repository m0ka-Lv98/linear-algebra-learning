...
Course 02「線形代数」第216 Topic。線形代数の定義・計算・幾何を接続する。

## 今回解く問い

Gram–Schmidt法とQR分解を、ベクトル・行列のshape、定義、幾何的意味、数値計算からどう理解するか。
...
[la-orthogonal-orthonormal-bases](/courses/foundation/la-orthogonal-orthonormal-bases)
