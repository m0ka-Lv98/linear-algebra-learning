...
Course 02「線形代数」第211 Topic。線形代数の定義・計算・幾何を接続する。

## 今回解く問い

階数とrank-nullityを、ベクトル・行列のshape、定義、幾何的意味、数値計算からどう理解するか。
...
[la-column-space-null-space](/courses/foundation/la-column-space-null-space)
