...
Course 02「線形代数」第225 Topic。線形代数の定義・計算・幾何を接続する。

## 今回解く問い

Cholesky分解を、ベクトル・行列のshape、定義、幾何的意味、数値計算からどう理解するか。
...
[la-quadratic-forms-positive-definite](/courses/foundation/la-quadratic-forms-positive-definite)
