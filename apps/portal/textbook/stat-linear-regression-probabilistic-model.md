...
何をランダムな対象としてモデル化し、どの量を観測データから計算するのか。design matrix、response、parameter、Gaussian noise、homoscedasticity、residual、MLE、WLSへの接続はどの仮定で成立し、どこで統計推測や分類へ役立つのか。
...
[10問の演習と完全解答](/exercises/stat-linear-regression-probabilistic-model)
